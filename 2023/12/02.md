...
## わかったこと・復習になったこと
  ...
  - vercleのサーバーレス関数は、一定数を超えると費用が発生する
  - NextjsのRouteHandlersはサーバーレス関数になる
  - RailsのAPIモードでAPIをリクエストすれば、課金対象にはならない
...
## 感じたこと
- Vercelについて調査。
- NextjsだけでAPIも作れるし、簡単なアプリケーションであればスピード感を持って作れるし十分かなと思ってたけど、思ったよりお金がかかりそうな感じもする。
- 
