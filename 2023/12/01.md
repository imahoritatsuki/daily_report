...
## 感じたこと
- ランディングページを完成させた。
- これでようやく、ポートフォリオとして完成させたかった全ての要件を、一通り完了することができた。
- 静的な普通のサイトを作るのは、また練習をしないといけない。
- フォントの設定や、ファビコンなどはシンプルなものであればめっちゃ簡単に設定できた。
- スタイルについては、CSSモジュールズも今後使ってみたい。
