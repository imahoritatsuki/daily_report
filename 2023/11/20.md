...
## わかったこと・復習になったこと
  - [Next.js 13 Linkコンポーネントで別タブに遷移させる](https://www.notion.so/Next-js-13-Link-2d6fe548940b4850902a7c717b2f0fd4?pvs=4)（新）
...
## 感じたこと
- Notionからこれまで書いてきた学習メモをAPIで取得する機能を実装して見た。
- APIをたたいてCRUD操作を実行するのは、Railsの練習おかげでかなり慣れてきた。
- チャットアプリを作るのは、Stateの勉強になる。
- 明日はチャットアプリの機能を大枠完成させ、Supabaseでのメッセージ管理をできるようにする。
